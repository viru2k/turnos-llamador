...
export class NavbarComponent implements OnInit {
    ...
    if (conexion == null) {
      ...
      if (currentUser.access_token !== "") {
        ...
        this.alertServiceService.throwAlert(
          ...
          "Verifique el usuario y contraseña, su sesion puede haber expirado",
          "500"
        );
      }
    }
  ...
  asignarModulos(modulos: any) {
    modulos.forEach((element) => {
      ...
      if (element.modulo_nombre === "turnos") {
        this.turnos = false;
      }
    });
  ...
  menuList() {
    this.general = [
      ...
      { label: "Números", visible: !this.turnos, routerLink: "atencion" },
      {
        label: "Mantenimiento",
  ...
  obtenerDatosPuestos() {
    ...
    this.turnoService.getSectorByUsuario(userData.id).subscribe(
      (resp) => {
        console.log(resp);
        localStorage.removeItem("turnoDato");
